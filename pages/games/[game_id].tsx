...
import { IScreenshots } from "../../interfaces";
...
const GamePage: React.FC<GamePageProps> = ({ game, screenshots }) => {
        ...
        <GameMainInfo>
          ...
          <GameInfo>
            ...
            <GameMetaList>
              {game.released && (
                <GameMetaItem>
                  <GameMetaTitle>Release date:</GameMetaTitle>
                  <GameMetaText>{formattedDate}</GameMetaText>
                </GameMetaItem>
              )}
              <GameMetaItem>
                <GameMetaTitle>Rating:</GameMetaTitle>
                <GameMetaText>{game.rating}</GameMetaText>
              </GameMetaItem>
              {game.website && (
                <GameMetaItem>
                  <GameMetaTitle>Website:</GameMetaTitle>
